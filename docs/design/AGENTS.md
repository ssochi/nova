...
- `slice-runtime-values.md`: design baseline for slice runtime values, typed zero-value declarations, shared storage, helper builtins, and layered test coverage
