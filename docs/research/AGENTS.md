...
- `2026-03-20-slice-expressions-and-assignment.md`: official behavior baseline for the current slice surface, including slice expressions, assignment, typed zero values, `cap`, `copy`, and append-capacity semantics
