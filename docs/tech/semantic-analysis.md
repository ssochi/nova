...
- Validate builtin `panic(...)` calls as terminating paths for conservative non-void fallthrough analysis instead of forcing explicit unreachable `return` statements after known panic sites.
