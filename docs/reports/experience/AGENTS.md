...
- `2026-03-20-type-switches-and-comma-ok-assertions-playtest.md`: records the CLI walkthrough for staged comma-ok assertions, explicit type switches, typed-nil versus `case nil`, and type-switch diagnostics
