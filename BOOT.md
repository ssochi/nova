...
42. When `run` fails during runtime execution, preserve any already-buffered program output in the user-visible diagnostic so deferred prints and other pre-failure output are not silently dropped.
